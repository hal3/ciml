...
\dependencies{\chref{ch:dt},\chref{ch:knn},\chref{ch:perc}}
...
\TODOFigure{prac:addirel}{data from high dimensional warning, interpolated}
...
\thinkaboutit{Earlier we discussed the problem of \emph{scale} of
  features (eg., millimeters versus centimeters).  Does this have an
