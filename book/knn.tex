...
(e.g., words that occur in the review) forms the useful abstraction for
...
\Figure{knn:projections}{A figure showing projections of data in
...
\thinkaboutit{Match the example ids from Table~\ref{tab:data:course}
  with the points in Figure~\ref{fig:knn:projections}.}
...
\Figure{knn:euclidean}{A figure showing Euclidean distance in
  three dimensions}
...
\Figure{knn:classifyitbad}{A figure showing an easy NN
...
\Figure{knn:ski}{A figure of a ski and snowboard with width (mm)
  and height (cm).}
...
\Figure{knn:db}{decision boundary for knn with k=3.}
