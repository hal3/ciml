...
\Figure{dt_induction.svg}{The general supervised approach to machine
...
latter is the \emph{parity} function, which requires you to inspect
...
There has been a significant amount of work that considers more advanced splitting criteria; the two most popular are ID3 \cite{quinlan} and the Gini index \cite{gini}.
...
Again, there are more advanced ``tree pruning'' techniques \cite{pruning} that typically operate by growing deep trees and then pruning back some of the branches.
