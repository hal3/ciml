...
exponential of the distance between the test point and itself.  ù
\item This
...
and $b$.
\item  However, you are now an expert with using Lagrange
...
multipliers.
\item  The main difference is that the Lagrange multipliers are
