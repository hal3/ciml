...
\begin{itemize}
\item 
The only major difference between is that the hidden units compute a \emph{non-linear}
...
$\tanh$ function 
\Figure{nnet:tanh}{picture of sign versus tanh}{0.4}
\item It
...
at $\vw_i$ should also flip signs.
\item  The name
...
\item If you use \emph{fewer} hidden units than data point, you can think
